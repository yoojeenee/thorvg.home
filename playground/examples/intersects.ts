...
{
  const response = await fetch('playground/assets/images/test.jpg');
  ...
  // Vector scene (tiger)
  const svgResponse = await fetch('playground/assets/images/tiger.svg');
